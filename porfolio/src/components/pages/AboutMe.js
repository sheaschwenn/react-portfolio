...
export default function About(){
    return(
        ...
        //         <image  width= 100% height =100% preserveAspectRatio = "xMinYMin slice" xlink:href="images\profile-pic.jpeg" clip-path="url(#blob)" />
        //     </svg>
        // </section>
        <div>
                <h2>ABOUT ME</h2>
                <p>Hi! I am a California based fullstack web developer! My current skills include HTML, CSS, JavaSCript, React, SQL, MongoDB and so much more! 
                    Check out my portfolio to see some of my previous work and my Linked-in to see a full list of my current skills. </p>
            </div>
    // </section>
    )
}